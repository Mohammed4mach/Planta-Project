...
*/
    ...
    if (isset($_POST['username'])) {
        ...
        $cpassword = sanInput($_POST['confirm_password']);
        ...
        if ($password == $cpassword) {
            ...
            if (count($rows)) {
                ...
                $sql = "INSERT INTO users (user_id ,username, email, password, gender, birth_date, create_date)
                VALUES (?, ?, ?, ?, ?, ?, ?)";
                $rows = executeSQL($conn, $sql, 'issssss', $user_id, $username, $email, $password, $gender, $birth_date, $create_date);
