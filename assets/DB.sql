...
CREATE TABLE plants
	(
		plant_id INT(9) UNSIGNED NOT NULL PRIMARY KEY,
...
/* Insert admin users */
INSERT INTO users (user_id, username, email, password, gender, birth_date, img_path, create_date, admin)
            VALUES
                (
                    1,
                    "Admin",
...
/* Insert plants data */
INSERT INTO plants (plant_id, plant_name, info, img_path)
            VALUES
                (
                    869964053,
                    "Hibiscus",
